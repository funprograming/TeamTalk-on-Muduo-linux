...
template <> struct is_proto_enum< ::server_base::ResultType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::server_base::ResultType>() {
  return ::server_base::ResultType_descriptor();
}
